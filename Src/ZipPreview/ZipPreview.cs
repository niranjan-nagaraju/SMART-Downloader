...
{
    public class ZipPreview : IEnumerable
    {
        ZipEntry[] entries;
        string baseUrl;
        int MaxFileOffset;
        ...
        class PartialInputStream : InflaterInputStream
        {
            ...
            public PartialInputStream(Stream baseStream, HttpWebResponse request, long len)
                : base(baseStream)
            {
    ...
    public class ZipOutputStream : DeflaterOutputStream
    {
        ...
        public void PutNextEntry(ZipEntry entry)
        {
            ...
            switch (method)
            {
                case CompressionMethod.Stored:
                    ...
                    break;
                case (CompressionMethod)12:
                    startPosition = baseOutputStream.Position;
                    additionalStream = new BZip2OutputStream(new NoCloseSubStream(baseOutputStream));
        ...
        public void CloseEntry()
        {
            ...
            else if (curMethod == (CompressionMethod)12)
            {
                ...
                csize = (int)(baseOutputStream.Position - startPosition);
            }
            else
                csize = size;
