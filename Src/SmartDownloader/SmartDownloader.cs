        ...
        class App : WindowsFormsApplicationBase
        {
            ...
            protected override void OnCreateMainForm()
            {
                ...
                // but don't try to run it.
                 ...
                 this.MainForm = new SmartDownloaderGUI();

                // We want to pass along the command-line arguments to this first instance

                // Allocate room in our string array
                 ((SmartDownloaderGUI)this.MainForm).Args = new string[this.CommandLineArgs.Count];
                
                // And copy the arguments over to our form
                this.CommandLineArgs.CopyTo(((SmartDownloaderGUI)this.MainForm).Args, 0);
            }
                ...
                StartupNextInstanceEventArgs eventArgs)
            {
                ...
                this.MainForm.Invoke(new SmartDownloaderGUI.ProcessParametersDelegate(
                    ((SmartDownloaderGUI)this.MainForm).ProcessParameters), 
                    parameters );
            }
        }
    } 
